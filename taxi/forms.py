...
class LicenseUpdateValidationMixin():
...
class DriverCreationForm(LicenseUpdateValidationMixin, UserCreationForm):
...
class DriverLicenseUpdateForm(LicenseUpdateValidationMixin, forms.ModelForm):
